...
loadAnnFixedProteins = function(object, A)
{
...
glmnetDalpha = function(Y,X, MAXVAR)
{
        ...
        f = cv.glmnet(y = Yf, x = Xf, family = "binomial" , dfmax = MAXVAR, alpha=0.5, maxit=9000, type.measure="auc");
